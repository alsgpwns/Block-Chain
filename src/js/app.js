    ...
    App.contracts.RealEstate.deployed().then(function(instance) {
      ...
      for (i = 0; i < buyers.length; i++) {
        if (buyers[i] !== '0x0000000000000000000000000000000000000000') {
          ...
          switch(imgType) {
            case 'Fold.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/Fold_s.jpg')
              break;
            case 'GG.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/GG_s.jpg')
              break;
            case 'Lug.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/Lug_s.jpg')
              break;
            case 'Mac.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/Mac_s.jpg')
              break;
            case 'book.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/book_s.jpg')
              break;
            case 'sho.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/sho_s.jpg')
              break;
            case 'gbook.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/gbook_s.jpg')
              break;
            case 'hang.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/hang_s.jpg')
              break;
            case 'cat.jpg':
              $('.panel-realEstate').eq(i).find('img').attr('src', 'images/cat_s.jpg')
              break;
